...
/**
 * Ajoute au panier la référence de produits de chien sélectionnée
 *
 * Conserve en variable session la référence du produit
 * @param string ref de produit
 * @return void
 */
class Panier
{
    ...
    /**
     * Retirer du panier la référence de produit sélectionnée
     *
     * Conserve en variable session la référence des produits
     * @param string : référence du produit
